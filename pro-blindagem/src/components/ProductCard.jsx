...
const ProductCard = ({
  ...
  category = "Categoria",
  footerInfo = "30 Min | 1 Porção",
  backTitle = "Ver Detalhes",
  ...
  return (
    <div className={`productCard3D ${className}`} onClick={onClick}>
      <div className="productCard3D__inner">
        {/* VERSO DO CARD */}
        <div className="productCard3D__back">
          <div className="productCard3D__backDecor"></div>
          <div className="productCard3D__backContent">
            {customIcon || (
              <svg className="productCard3D__backIcon" viewBox="0 0 50 50">
            ...
            <strong className="productCard3D__backText">{backTitle}</strong>
          </div>
        </div>

        {/* FRENTE DO CARD */}
        <div className="productCard3D__front">
          {/* ÁREA DE IMAGEM */}
          <div className="productCard3D__imageArea">
            {/* Elementos decorativos */}
            <div className="productCard3D__decorCircle productCard3D__decorCircle--primary"></div>
            <div className="productCard3D__decorCircle productCard3D__decorCircle--right"></div>
            <div className="productCard3D__decorCircle productCard3D__decorCircle--bottom"></div>
            ...
            {imageUrl ? (
              <img
                src={imageUrl}
                alt={title}
                className="productCard3D__productImage"
              />
            ) : (
              <div className="productCard3D__imagePlaceholder">
          ...
          {/* CONTEÚDO DA FRENTE */}
          <div className="productCard3D__frontContent">
            <span
              className="productCard3D__categoryBadge"
              style={{ backgroundColor: categoryColor }}
            >
              {category}
            </span>

            <div className="productCard3D__productInfo">
              <div className="productCard3D__titleRow">
                <h3 className="productCard3D__productTitle">{title}</h3>
                <svg
                  className="productCard3D__titleIcon"
                  viewBox="0 0 256 256"
              ...
              <p className="productCard3D__productSubtitle">{subtitle}</p>
              <div className="productCard3D__footerDetails">
                <span className="productCard3D__footerText">{footerInfo}</span>
              </div>
            </div>
          </div>
        </div>
